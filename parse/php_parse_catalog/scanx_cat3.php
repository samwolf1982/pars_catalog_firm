...
/*$firephp = FirePHP::getInstance(true);
  ...
  die();
     ...
     $res1=array($_POST['param'][0]);

$file = fopen("res3/errrofile.csv","ab");
 fputcsv($file,$res1);
fclose($file);
      echo "ERRROR ".$_POST['param'][0];
       die();
    }
...
$bread1='#main div[itemprop="location"]';
  $bread1a=$document->find($bread1);
         $txt=pq($bread1a)->text();
...
$file = fopen("res3/s1_ready.csv","ab");
 fputcsv($file,$res);
fclose($file);
